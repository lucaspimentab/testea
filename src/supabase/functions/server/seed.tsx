...
export const ongs = [
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=800&h=600&fit=crop"],
    areasAtuacao: ["Educação", "Crianças e Adolescentes"],
    idiomas: ["Português"],
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?w=800&h=600&fit=crop"],
    areasAtuacao: ["Cultura e Arte", "Educação"],
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800&h=600&fit=crop"],
    areasAtuacao: ["Meio Ambiente"],
    idiomas: ["Português"],
    horarios: ["Manhã"],
    latitude: -19.9245,
    longitude: -43.9402,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=800&h=600&fit=crop"],
    areasAtuacao: ["Assistência Social", "Saúde"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9178,
    longitude: -43.9356,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?w=800&h=600&fit=crop"],
    areasAtuacao: ["Educação", "Trabalho e Emprego"],
    idiomas: ["Português"],
    horarios: ["Tarde", "Noite"],
    latitude: -19.9356,
    longitude: -43.9289,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1516733725897-1aa73b87c8e8?w=800&h=600&fit=crop"],
    areasAtuacao: ["Idosos", "Saúde"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9334,
    longitude: -43.9356,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=800&h=600&fit=crop"],
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=800&h=600&fit=crop"],
    areasAtuacao: ["Pessoas com Deficiência", "Trabalho e Emprego"],
    idiomas: ["Português", "Libras"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9189,
    longitude: -43.9378,
    verificada: true,
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&h=600&fit=crop"],
    areasAtuacao: ["Saúde"],
    idiomas: ["Português"],
    horarios: ["Manhã"],
    latitude: -19.9289,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1499781350541-7783f6c6a0c8?w=800&h=600&fit=crop"],
    areasAtuacao: ["Cultura e Arte", "Crianças e Adolescentes"],
    idiomas: ["Português"],
    horarios: ["Tarde", "Noite"],
    latitude: -19.9345,
    longitude: -43.9378,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1450778869180-41d0601e046e?w=800&h=600&fit=crop"],
    areasAtuacao: ["Animais"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9112,
    longitude: -43.9289,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=800&h=600&fit=crop"],
    areasAtuacao: ["Direitos Humanos", "Saúde"],
    idiomas: ["Português", "Espanhol"],
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=800&h=600&fit=crop"],
    areasAtuacao: ["Assistência Social", "Moradia"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde", "Noite"],
    latitude: -19.9223,
    longitude: -43.9434,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1509099836639-18ba1795216d?w=800&h=600&fit=crop"],
    areasAtuacao: ["Trabalho e Emprego", "Assistência Social"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9267,
    longitude: -43.9389,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800&h=600&fit=crop"],
    areasAtuacao: ["Crianças e Adolescentes", "Educação"],
    idiomas: ["Português"],
    horarios: ["Tarde"],
    latitude: -19.9312,
    longitude: -43.9445,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=800&h=600&fit=crop"],
    areasAtuacao: ["Esporte", "Crianças e Adolescentes"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9378,
    longitude: -43.9301,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=800&h=600&fit=crop"],
    areasAtuacao: ["Educação", "Cultura e Arte"],
    idiomas: ["Português"],
    horarios: ["Tarde", "Noite"],
    latitude: -19.9289,
    longitude: -43.9412,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&h=600&fit=crop"],
    areasAtuacao: ["Crianças e Adolescentes", "Trabalho e Emprego"],
    idiomas: ["Português", "Inglês"],
    horarios: ["Tarde", "Noite"],
    latitude: -19.9245,
    longitude: -43.9356,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=800&h=600&fit=crop"],
    areasAtuacao: ["Meio Ambiente", "Trabalho e Emprego"],
    idiomas: ["Português"],
    horarios: ["Manhã"],
    latitude: -19.9198,
    longitude: -43.9367,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=800&h=600&fit=crop"],
    areasAtuacao: ["Pessoas com Deficiência", "Cultura e Arte"],
    idiomas: ["Português", "Libras"],
    horarios: ["Tarde"],
    latitude: -19.9201,
    longitude: -43.9389,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1527689368864-3a821dbccc34?w=800&h=600&fit=crop"],
    areasAtuacao: ["Saúde"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde", "Noite"],
    latitude: -19.9234,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=800&h=600&fit=crop"],
    areasAtuacao: ["Meio Ambiente", "Assistência Social"],
    idiomas: ["Português"],
    horarios: ["Manhã"],
    latitude: -19.9256,
    longitude: -43.9401,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=800&h=600&fit=crop"],
    areasAtuacao: ["Cultura e Arte", "Crianças e Adolescentes"],
    idiomas: ["Português"],
    horarios: ["Tarde", "Noite"],
    latitude: -19.9189,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=800&h=600&fit=crop"],
    areasAtuacao: ["Direitos Humanos", "Educação"],
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=800&h=600&fit=crop"],
    areasAtuacao: ["Direitos Humanos"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9223,
    longitude: -43.9412,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=800&h=600&fit=crop"],
    areasAtuacao: ["Pessoas com Deficiência", "Educação"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9178,
    longitude: -43.9367,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=800&h=600&fit=crop"],
    areasAtuacao: ["Educação", "Trabalho e Emprego"],
    idiomas: ["Português"],
    horarios: ["Tarde", "Noite"],
    latitude: -19.9198,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop"],
    areasAtuacao: ["Moradia", "Direitos Humanos"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9301,
    longitude: -43.9434,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=800&h=600&fit=crop"],
    areasAtuacao: ["Trabalho e Emprego"],
    idiomas: ["Português"],
    horarios: ["Tarde", "Noite"],
    latitude: -19.9123,
    longitude: -43.9301,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1503095396549-807759245b35?w=800&h=600&fit=crop"],
    areasAtuacao: ["Cultura e Arte"],
    idiomas: ["Português"],
    horarios: ["Noite"],
    latitude: -19.9212,
    longitude: -43.9423,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1517841905240-472988babdf9?w=800&h=600&fit=crop"],
    areasAtuacao: ["Direitos Humanos", "Saúde"],
    idiomas: ["Português"],
    horarios: ["Tarde", "Noite"],
    latitude: -19.9234,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?w=800&h=600&fit=crop"],
    areasAtuacao: ["Cultura e Arte", "Educação"],
    idiomas: ["Português"],
    horarios: ["Tarde", "Noite"],
    latitude: -19.9323,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&h=600&fit=crop"],
    areasAtuacao: ["Trabalho e Emprego", "Crianças e Adolescentes"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9301,
    longitude: -43.9423,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1516733725897-1aa73b87c8e8?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1516733725897-1aa73b87c8e8?w=800&h=600&fit=crop"],
    areasAtuacao: ["Saúde", "Pessoas com Deficiência"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9256,
    longitude: -43.9367,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1508700929628-666bc8bd84ea?w=800&h=600&fit=crop"],
    areasAtuacao: ["Cultura e Arte", "Pessoas com Deficiência"],
    idiomas: ["Português", "Libras"],
    horarios: ["Tarde", "Noite"],
    latitude: -19.9209,
    longitude: -43.9378,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&h=600&fit=crop"],
    areasAtuacao: ["Direitos Humanos"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9212,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800&h=600&fit=crop"],
    areasAtuacao: ["Meio Ambiente", "Educação"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9245,
    longitude: -43.9434,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1494059980473-813e73ee784b?w=800&h=600&fit=crop"],
    areasAtuacao: ["Direitos Humanos"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9267,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=800&h=600&fit=crop"],
    areasAtuacao: ["Cultura e Arte", "Crianças e Adolescentes"],
    idiomas: ["Português"],
    horarios: ["Tarde"],
    latitude: -19.9201,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1511895426328-dc8714191300?w=800&h=600&fit=crop"],
    areasAtuacao: ["Pessoas com Deficiência", "Saúde"],
    idiomas: ["Português"],
    horarios: ["Noite"],
    latitude: -19.9367,
    longitude: -43.9301,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=800&h=600&fit=crop"],
    areasAtuacao: ["Cultura e Arte"],
    idiomas: ["Português"],
    horarios: ["Noite"],
    latitude: -19.9345,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?w=800&h=600&fit=crop"],
    areasAtuacao: ["Meio Ambiente"],
    idiomas: ["Português"],
    horarios: ["Manhã"],
    latitude: -19.9198,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=800&h=600&fit=crop"],
    areasAtuacao: ["Assistência Social", "Saúde"],
    idiomas: ["Português"],
    horarios: ["Tarde"],
    latitude: -19.9312,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1545221308-fbb6dc7ff7e4?w=800&h=600&fit=crop"],
    areasAtuacao: ["Trabalho e Emprego"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9134,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=800&h=600&fit=crop"],
    areasAtuacao: ["Assistência Social", "Meio Ambiente"],
    idiomas: ["Português"],
    horarios: ["Manhã"],
    latitude: -19.9223,
    longitude: -43.9434,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=800&h=600&fit=crop"],
    areasAtuacao: ["Cultura e Arte", "Trabalho e Emprego"],
    idiomas: ["Português"],
    horarios: ["Tarde"],
    latitude: -19.9389,
    longitude: -43.9323,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1518791841217-8f162f1e1131?w=800&h=600&fit=crop"],
    areasAtuacao: ["Cultura e Arte", "Esporte"],
    idiomas: ["Português"],
    horarios: ["Tarde", "Noite"],
    latitude: -19.9267,
    longitude: -43.9378,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=800&h=600&fit=crop"],
    areasAtuacao: ["Assistência Social", "Direitos Humanos"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9209,
    longitude: -43.9389,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=800&h=600&fit=crop"],
    areasAtuacao: ["Saúde", "Esporte"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9201,
    longitude: -43.9401,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1554224311-9558f6d503b6?w=800&h=600&fit=crop"],
    areasAtuacao: ["Educação", "Assistência Social"],
    idiomas: ["Português"],
    horarios: ["Noite"],
    latitude: -19.9345,
    longitude: -43.9378,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=800&h=600&fit=crop"],
    areasAtuacao: ["Educação"],
    idiomas: ["Português"],
    horarios: ["Tarde"],
    latitude: -19.9189,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=800&h=600&fit=crop"],
    areasAtuacao: ["Saúde"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9209,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=800&h=600&fit=crop"],
    areasAtuacao: ["Crianças e Adolescentes", "Direitos Humanos"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9323,
    longitude: -43.9456,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=600&fit=crop"],
    areasAtuacao: ["Trabalho e Emprego"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9234,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1528819622765-d6bcf132f793?w=800&h=600&fit=crop"],
    areasAtuacao: ["Educação", "Esporte"],
    idiomas: ["Português"],
    horarios: ["Tarde"],
    latitude: -19.9245,
    longitude: -43.9467,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&h=600&fit=crop"],
    areasAtuacao: ["Saúde", "Direitos Humanos"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9345,
    longitude: -43.9478,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&h=600&fit=crop"],
    areasAtuacao: ["Trabalho e Emprego", "Direitos Humanos"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9312,
    longitude: -43.9445,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800&h=600&fit=crop"],
    areasAtuacao: ["Educação"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9234,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&h=600&fit=crop"],
    areasAtuacao: ["Meio Ambiente"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9267,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800&h=600&fit=crop"],
    areasAtuacao: ["Saúde", "Educação"],
    idiomas: ["Português"],
    horarios: ["Tarde"],
    latitude: -19.9289,
    longitude: -43.9434,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?w=800&h=600&fit=crop"],
    areasAtuacao: ["Cultura e Arte", "Idosos"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9212,
    longitude: -43.9412,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=800&h=600&fit=crop"],
    areasAtuacao: ["Esporte", "Pessoas com Deficiência"],
    idiomas: ["Português", "Libras"],
    horarios: ["Tarde"],
    latitude: -19.9201,
    longitude: -43.9401,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=800&h=600&fit=crop"],
    areasAtuacao: ["Educação", "Cultura e Arte"],
    idiomas: ["Português"],
    horarios: ["Noite"],
    latitude: -19.9220,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=800&h=600&fit=crop"],
    areasAtuacao: ["Assistência Social", "Trabalho e Emprego"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9378,
    longitude: -43.9423,
  ...
  },
  {
    ...
    imagens: ["https://images.unsplash.com/photo-1519315901367-f34ff9154487?w=800&h=600&fit=crop"],
    areasAtuacao: ["Esporte", "Saúde"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9256,
    longitude: -43.9478,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800&h=600&fit=crop"],
    areasAtuacao: ["Saúde", "Crianças e Adolescentes"],
    idiomas: ["Português"],
    horarios: ["Tarde"],
    latitude: -19.9301,
    longitude: -43.9434,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=800&h=600&fit=crop"],
    areasAtuacao: ["Saúde", "Meio Ambiente"],
    idiomas: ["Português"],
    horarios: ["Manhã"],
    latitude: -19.9289,
    longitude: -43.9401,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=800&h=600&fit=crop"],
    areasAtuacao: ["Meio Ambiente", "Direitos Humanos"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9301,
    longitude: -43.9445,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=200&h=200&fit=crop",
    imagens: ["https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&h=600&fit=crop"],
    areasAtuacao: ["Direitos Humanos", "Assistência Social"],
    idiomas: ["Português"],
    horarios: ["Manhã", "Tarde"],
    latitude: -19.9401,
    longitude: -43.9334,
...
export async function seedDatabase() {
  ...
  // Seed perguntas (Q&A) sintéticas para as primeiras ONGs
  const samplePerguntas = [
    {
      id: crypto.randomUUID(),
      ongId: "1",
      pergunta: "Como posso me inscrever como voluntário nas atividades de reforço escolar?",
      resposta: "Preencha o formulário de interesse no site ou envie um e-mail para contato@acaosolidaria.org.br.",
    ...
    },
    {
      id: crypto.randomUUID(),
      ongId: "2",
      pergunta: "Vocês oferecem certificados para voluntários nas oficinas de teatro?",
      resposta: "Sim, emitimos certificados semestrais para os voluntários ativos.",
      criadoEm: new Date().toISOString(),
      atualizadoEm: new Date().toISOString(),
    },
    {
      id: crypto.randomUUID(),
      ongId: "3",
      pergunta: "As ações de reflorestamento têm transporte incluso?",
      resposta: "Oferecemos transporte compartilhado saindo do Centro aos domingos às 6h30.",
      criadoEm: new Date().toISOString(),
      atualizadoEm: new Date().toISOString(),
    },
    {
      id: crypto.randomUUID(),
      ongId: "1",
      pergunta: "Quais dias funcionam os atendimentos psicológicos?",
      resposta: "De segunda a sexta, 8h às 17h, com agendamento prévio.",
      criadoEm: new Date().toISOString(),
      atualizadoEm: new Date().toISOString(),
    }
  ];

  for (const pergunta of samplePerguntas) {
    await kv.set(`perguntas:${pergunta.id}`, pergunta);
  }
  console.log(`Seeded ${samplePerguntas.length} sample perguntas`);
